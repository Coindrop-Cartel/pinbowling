...
describe('Utility Functions (utils.js)', () => {
  ...
  describe('printMachineScores', () => {
    ...
    it('should open a new window and write machine scores HTML', () => {
      ...
      Utils.printMachineScores(machines);
      ...
      expect(html).toContain('10,000'); // Check for the score value
      expect(html).toContain('20,000'); // Check for the score value
    });
  ...
  describe('printBlankScoreSheet', () => {
    ...
    it('should open a new window and write blank score sheet HTML', () => {
      const machines = [
        ...
        { id: 2, machine_name: 'Machine B', order_number: 2, values: { 10: 20000 } },
      ];
      Utils.printBlankScoreSheet(machines);
