...
const ROLE_PERMISSIONS = {
  'admin': ['*'],
  'td': [PERMISSIONS.CREATE_SESSION, PERMISSIONS.JOIN_SESSION, PERMISSIONS.ADD_ANY_SCORE, PERMISSIONS.UPDATE_ANY_SCORE, PERMISSIONS.MANAGE_LEAGUES, PERMISSIONS.MANAGE_MACHINES, PERMISSIONS.MANAGE_PLAYERS, PERMISSIONS.ADD_LOCATION_MACHINE],
