...
if (isset($_COOKIE['pb_dark_mode']) && $_COOKIE['pb_dark_mode'] === 'true') {
  $mainSiteLogo = 'main-site-logo-header-darkmode.png';
}
?>
  ...
  <div class="nav-container">
    ...
    <div class="nav-collapse">
      ...
      <div id="auth-header-container" class="auth-header" data-auth-state="<?php echo $userId; ?>">
        ...
        <button id="theme-toggle-btn" class="theme-toggle-btn" aria-label="Toggle dark mode" title="Toggle Dark Mode"><svg class="theme-toggle-icon" viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg></button>
      </div>
    </div>
  </div>
</nav>